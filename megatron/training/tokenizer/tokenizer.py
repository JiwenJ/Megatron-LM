...
class _Llama3Tokenizer(MegatronTokenizer):
    ...
    def __init__(self, model_path, vocab_extra_ids=0):
        super().__init__(model_path, vocab_extra_ids=vocab_extra_ids)
        ...
        self.n_words: int = self.tokenizer.n_vocab
        # BOS / EOS token IDs
    ...
    def decode(self, t: Sequence[int]) -> str:
        ...
        return self.tokenizer.decode(cast(List[int], t))
    ...
    def tokenize(self, s: str, bos=True, eos=False):
        '''Default args for text completion, not chat/dialog.'''
        assert type(s) is str
        return self.encode(s, bos=True, eos=False)
